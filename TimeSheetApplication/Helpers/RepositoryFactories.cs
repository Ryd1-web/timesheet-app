...
namespace TimeSheetApplication.Helpers
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<TimesheetContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<TimesheetContext, object>>
            {
                {typeof(IEmployeeInfoRepository), dbContext => new EmployeeInfoRepository(dbContext)},
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<TimesheetContext, object>> factories )
        {
        ...
        /// </remarks>
        public Func<TimesheetContext, object> GetRepositoryFactory<T>()
        {
       
            Func<TimesheetContext, object> factory;
        ...
        /// </remarks>
        public Func<TimesheetContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        protected virtual Func<TimesheetContext, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<TimesheetContext, object>> _repositoryFactories;
