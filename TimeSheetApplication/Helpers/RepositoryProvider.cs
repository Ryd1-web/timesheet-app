...
namespace TimeSheetApplication.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public TimesheetContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TimesheetContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TimesheetContext, object> factory, TimesheetContext dbContext)
        {
